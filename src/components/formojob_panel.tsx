    ...
    return (
        <div>
            ...
            <div className='instructionsContainer'>
                <Instruction title='Create a template' description='1' image='0' signature='FormoJob Designer - Desktop view' />
                <Instruction title='Auto-fill a contract' description='2' image='0' signature='FormoJob Viewer - Mobile view' />
            </div>
        </div>
    )
}